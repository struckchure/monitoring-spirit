...
$BaseUrl = "https://github.com/struckchure/monitoring-spirit/releases/download/$Version"

# Define the file names (adjust these as needed)
$Windows_AMD64 = "ms_Windows_x86_64.zip"
$Windows_ARM64 = "ms_Windows_arm64.zip"
...
$DestDir = "$env:USERPROFILE\.monitoring-spirit\bin"
...
# Extract the downloaded file to the .monitoring-spirit\bin directory
...
# Add .monitoring-spirit\bin to the PATH if it's not already there
$PathEntry = "$DestDir"
