...
BASE_URL="https://github.com/struckchure/monitoring-spirit/releases/download/${VERSION}"

# Define the file names (adjust these as needed)
LINUX_AMD64="ms_Linux_x86_64.tar.gz"
LINUX_ARM64="ms_Linux_arm64.tar.gz"
MACOS_AMD64="ms_Darwin_x86_64.tar.gz"
MACOS_ARM64="ms_Darwin_arm64.tar.gz"
...
DEST_DIR="$HOME/.monitoring-spirit/bin"
...
# Extract the downloaded file to the .monitoring-spirit directory
...
# Add .monitoring-spirit directory to PATH if not already present
